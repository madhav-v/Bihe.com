    ...
    return (
        <>
            <div className='realtive'>
                <div className=' flex max-h-screen  w-screen fixed  top-0 left-0 bottom-0 '>
                        ...
                        <div className=' z-10  h-[15vh]'>
                            <div className='flex justify-between'>
                                ...
                                <div className='flex space-x-3'>
                                    <p className='bg-gray-500 h-8 w-8 rounded-full relative '><BsThreeDots size={22} style={{ position: "absolute", top: "4px", left: "4px", color: "white" }} /></p>
                                    <p className='bg-gray-500 h-8 w-8 rounded-full relative '><MdMessage size={18} style={{ position: "absolute", top: "7px", left: "7px", color: "white" }} /></p>
                                </div>
                            </div>
                            <div className="relative my-2">
                                <AiOutlineSearch size={24} style={{ color: "gray", position: "absolute", top: "50%", left: "10px", transform: "translateY(-50%)" }} />
                                <input type="search" className="w-full my-4 rounded-2xl border border-gray-300 p-[6px] pl-10" placeholder="Search Message" />
                            </div>
                    ...
                    <div className='  w-[75%]  fixed left-[25%] h-full '>
                        ...
                        <div style={{ boxShadow: '0 -5px 10px rgba(0, 0, 0, 0.1)' }} className='  absolute bottom-0 bg-[white] w-full  p-4  flex items-center  justify-between  space-x-5 mr-5'>
                            ...
                            <div className='flex '>
                                <input type="text" className="  rounded-2xl bg-gray-200 p-[6px] pl-3 w-[600px] " placeholder="Aa" />
                            </div>
